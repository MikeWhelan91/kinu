...
#ifndef GODOTAPPLEPLUGINSFIREBASE_SWIFT_H
#define GODOTAPPLEPLUGINSFIREBASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GodotApplePluginsFirebase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_EXTERN uint8_t godot_apple_plugins_firebase_start(void * _Nullable getProcAddress, void * _Nullable library, void * _Nullable initialization) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
